...
class c_auth extends CI_Controller {
	...
	public function getLogin(){
		...
		if (isset($loginResult)) {
			...
			$this->session->set_flashdata('wrong_msg','Password / Username Salah!');
	...
	public function getIn($type, $currPage){
		$username = $this->input->post('username');
		$password = $this->input->post('password');
		...
		if (isset($loginResult)) {
			...
			$this->session->set_userdata($dataUser);
			redirect('c_backend/'.$currPage);
		}else{
			$this->session->set_flashdata('wrong_msg','Password Salah!');
			redirect('c_backend/'.$type);
		}
	}
